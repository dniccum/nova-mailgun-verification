<template>
    <div>
        <h1 class="mb-3 text-90 font-normal text-2xl">Mailgun Domain Verification</h1>
        <card class="card relative metric px-6 py-4 relative">
            <div v-if="loading">
            ...
            <div class="pt-2 pb-2" v-if="successfulResponse && !loading && !notAdded">
                ...
                <div class="pt-4" v-if="!verified">
                    ...
                    <div class="bg-20 border border-40 px-4 py-3 rounded relative mb-4" v-for="dnsRecord in recordsToAdd">
                        <div class="flex mb-2">
